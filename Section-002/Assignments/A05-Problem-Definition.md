...
| # | Spec | Met when... |
|---|------|-------------|
| 1 | Problem statement | Bounded, specific, traceable to research |
| 2 | Revised causal loop | Updated map with brief explanation of what changed |
| 3 | Hypotheses | 2-3 testable, linked to research, riskiest assumption identified |
