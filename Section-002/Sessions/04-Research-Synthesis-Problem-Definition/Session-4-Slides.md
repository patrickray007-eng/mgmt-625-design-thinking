---
source_pdf: "Session-4-Slides.pdf"
...
Thursday, March 26, 2026  |  6:30 PM  |  Online (Zoom)  |  Faculty: Patrick Ray
...
Find the Duct Tape
You've been in the field for two weeks. What duct tape did you find? What workarounds are
people using in the problem spaces you investigated?
...
Tonight's Plan
Before you touch your own data, we're going to practice synthesis together on a
shared dataset.
First Half
Guided synthesis on a real design
project's field data.
Second Half
Apply the same method to your own
research, then stress test your causal
loop maps.
3
...
Move from raw data to patterns to insight. The hardest design ability because your brain wants to
skip steps.
...
This data comes from real community spaces. If the content resonates personally, that's valid. We're
focused on synthesis as a method.
6
...
7 minutes  |  Silent
When time is up: drop in the chat the number of one observation that surprised you,
and one word for why.
7
...
"The younger person kept looking
around the room while writing."
Interpretation
What you think it means.
"...like she was blocking the view from the
rest of the room."
...
"I'm putting 1, 10, 20, and 33 together. They all vote, none have access problems. But they all say
...
"Trust issues"
Precise
"People who can access polls but
experience voting as hostile or pointless"
"Community infrastructure that replaces
institutional services"
"Rational withdrawal from systems
perceived as unsafe"
...
Synthesis doesn't just organize your data. It can break your frame.
13
...
Community self-reliance: Mutual aid, community fridges, legal networks. "We take care of
us."
Exhaustion: "I did everything right in 2020... I'm tired."
The problem isn't access. It's the relationship between this community and formal
institutions.
14
...
Your Turn
Your data will be harder because you're invested in it. That investment will make you
want to skip to conclusions.
Does your data confirm your assumptions, or does it tell a different story?
16
...
Due Apr 4
Due Apr 1
So I can review and give feedback
before Session 5
Final
Presentation
(A06)
...
Session 6
(Apr 9)
You'll run an experiment between S5
and S6, then present what you
learned
Reflection Essay
(A08)
Due Apr 9
...
What's Ahead
Session 5 (Sat Apr 4, in-person): You come in with a defined problem. We ideate,
stress test, and design experiments.
Session 6 (Thu Apr 9, online): You present what you tested and what you learned.
Find the Duct Tape: Keep collecting.
22