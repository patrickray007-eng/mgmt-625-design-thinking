...
type: Team
due: Session 9 (Wednesday, February 18)
points: 100
weight: 10%
---
...
- Synthesize diverse research findings into a coherent problem statement
- Articulate a bounded, specific, and actionable problem
- Connect problem definition to evidence from empathy work
- Demonstrate traceability from observation to problem framing

## Instructions

### Document Structure

Your Problem Definition Report should include:
...
- Key findings from stakeholder mapping (Session 6)
- Insights from [[A03-Causal-Loop-Map|causal loop analysis]]
- Observations and interviews from your team's Project 2 research
...
#### 4. Initial Solution Directions

Briefly identify 2-3 directions your team might explore for solutions:
- These are not fully developed solutions, just directions worth investigating
- For each, note which stakeholder insight points toward this direction
- You'll develop these further for Session 10 and Session 12

## Deliverables

Submit to Canvas before Session 9 (Wednesday, February 18):
- [ ] Problem Definition Report (PDF)
...
| Specification Met | Specification Not Met |
|-------------------|----------------------|
| Evidence summary includes specific findings from team's research: quotes, observations, examples from stakeholder mapping and team research. Clear connection between research and problem definition. Reader can see how empathy work led to this understanding. | Evidence is thin, generic, or missing. Problem definition could have been written on day one without research. No specific quotes or observations. Research section reads like filler rather than foundation. |
...
### Specification 4: Document Completeness

| Specification Met | Specification Not Met |
|-------------------|----------------------|
| All four sections present and complete. Writing is clear and professional. Formatting aids readability. Each section has sufficient depth to demonstrate genuine engagement. | Missing sections or significantly incomplete. Writing is unclear or disorganized. Sections are thin or padded with irrelevant content. |
